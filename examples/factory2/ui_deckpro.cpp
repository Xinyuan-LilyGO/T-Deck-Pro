...
{
    {SCREEN1_ID,  &img_loratest2,"Lora",     23,     13},  // Page one
    {SCREEN2_ID,  &img_setting2,"Setting",  95,     13},
    {SCREEN3_ID,  &img_gpstsst, "GPS",      167,    13},
    {SCREEN4_ID,  &img_wifi2,   "Wifi",     23,     101},
    {SCREEN5_ID,  &img_wifi2,   "Test",     95,     101},
    {SCREEN6_ID,  &img_batterytest, "Battery",  167,    101},
    {SCREEN7_ID,  &img_inputtest,   "Input",    23,     189},
    {SCREEN8_ID,  &img_calltest, "A7682E",   95,     189},
    {SCREEN9_ID,  &img_shutdowntest, "Shutdown", 167,    189},
    {SCREEN12_ID, &img_motortest, "Motor",    23,     13},  // Page two
...
static void menu_btn_create(lv_obj_t *parent, struct menu_btn *info)
{
    ...
    lv_obj_set_style_outline_color(btn, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_outline_opa(btn, LV_OPA_COVER, LV_PART_MAIN | LV_STATE_PRESSED);
